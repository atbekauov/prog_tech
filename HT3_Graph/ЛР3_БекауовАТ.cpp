...
tline::tline(int xx, int yy, int dxx, int dyy)
{
    x = xx;
    y = yy;
    dx = dxx;
...
tline::tline(int xx, int yy, int dxx, int dyy, int c)
{
    x = xx;
    y = yy;
    dx = dxx;
...
class tsquare: public tline
{
    public:
        tsquare();
        tsquare(int xx, int yx, int dxx, int dyy);
        tsquare(int xx, int yx, int dxx, int dyy, int c);
        ~tsquare();
